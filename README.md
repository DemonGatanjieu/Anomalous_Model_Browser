...
3. **Updating**: click the version number at the bottom of the sidebar and press **Check for updates**. From there you can update to the newest published release, roll back to an earlier one, or return to the latest version, then restart ComfyUI. The plugin never checks for updates on its own.
...
3. **更新插件**：点击侧边栏最底部的版本号，再点 **检查更新**。可以一键更新到最新发布版本、回退到以前的版本，或回到最新版，之后重启 ComfyUI 即可。插件不会自己联网检查更新。
